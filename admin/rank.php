...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body ng-app="adminapp3">
    	...
    	<div class="container">
    		<div class="row">
			   	<div  ng-controller="admincntrl3" class="col-md-12">
              ...
              <table class="table table-striped title1" >
                  ...
                  $limit.=$a." , ".$b;
                    ...
                    while($row=mysql_fetch_array($q) )
                    {
                      $email=$row['email'];
                      $score=$row['score'];
                      $q12=mysql_query("SELECT * FROM user WHERE email='$email' " )or die('Error231');
  ...
  app.controller("admincntrl3",function($scope,$http){
    ...
    $scope.submit=function(){
      ...
      var http=$http({
        ...
        data:{
          email:$scope.email,
          mode:"select_student_to_next_test"
        },
